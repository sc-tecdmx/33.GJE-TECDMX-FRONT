        ...
        <div class="modal-overlay__modal-content p-3 rounded bg-white position-relative">
            ...
            <div class="modal-body fs-6">
                ...
                <form @submit.prevent="handleSubmit" class="w-100 h-auto">
                    ...
                    <!--INPUTS DINÁMICOS-->
                    <div v-for="input in inputs" :key="input.id" class="modal-input form-check">
...
<script setup lang="ts">
    ...
    import InptNormal from '../formulario/InptNormal.vue';
  ...
  emit('close');
    ...
    router.push({ name: 'jel-modalUser' }); // Cambia 'jel-permiso' por el nombre de la ruta deseada
    handleCloseModal(); // Cierra el modal después de la navegación
    };
