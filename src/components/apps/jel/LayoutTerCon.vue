<template>
    ...
    <div class="container">
        ...
        <diV class="scroll-container">
            ...
            <p class="p-2">
                <b class="text-center d-block p-1">ACEPTACIÓN DE LOS TÉRMINOS Y CONDICIONES DE USO</b>
...
I. El Acuerdo General 5/2020, que regula la implementación del Sistema, y que es su voluntad someterse a las disposiciones del mismo;
II. Utilizará el Sistema de manera responsable y exclusivamente para la impugnación, presentación de promociones y/o consulta de expedientes ante el Tribunal Electoral del Poder Judicial de la Federación,
III. La información que proporcionen para obtener su Cuenta Institucional es verdadera y se encuentra vigente, además de que puede ser corroborada con algún medio de prueba, en caso de ser requerido;
...
<b class="fs-5 p-2 d-block">REQUERIMIENTOS TÉCNICOS</b>
...
En el caso de pérdida de la contraseña de acceso a la cuenta, será obligación del usuario reponerla a través del procedimiento establecido para tal efecto, y su mal uso, así como la inactividad de la misma, por más de 2 años, serán causa para su baja.
        ...
        <div class="form-check mt-5">
            ...
            <lbl-base
            lbl="Acepto las condiciones del servicio y avisos de privacidad."
            />
        </div>
        <!--END INPUT-->
