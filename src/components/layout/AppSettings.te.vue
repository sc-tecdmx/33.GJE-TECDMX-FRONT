        ...
        <div class="app-settings" :class="{ active: isOpen }">
            ...
            <div class="sidbarchat p-3">
                ...
                <div class="text-center">
                    <img src="/src/assets/tecdmx/images/features_overview.svg" alt="..." class="img-fluid" />
                </div>
                ...
                <div class="btn-group-toggle row mb-4 mx-0">
                    ...
                    <div class="text-color radio-primary col-12 ps-0 custom-control custom-radio">
                        <input type="radio" id="system_mode" v-model="themeStore.state.dark_mode"
                ...
                <div class="btn-group-toggle row mx-0">
                    <div class="text-color radio-primary col-3 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="boxed" v-model="themeStore.state.layout_style"
                            class="custom-control-input" value="boxed-layout" @change="setLayoutStyle" />
                    ...
                    <div class="text-color radio-primary col-5 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="largeboxed" v-model="themeStore.state.layout_style"
                    ...
                    <div class="text-color radio-primary col-4 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="full" v-model="themeStore.state.layout_style"
                            class="custom-control-input" value="full" @change="setLayoutStyle" />
