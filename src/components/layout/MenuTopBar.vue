        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled">
                    ...
                    <li>
                        <router-link to="/index">Analítica</router-link>
                    </li>
                </ul>
            </li>
                        ...
                        <ul class="collapse list-unstyled sub-submenu">
                            ...
                            <li class="sub-sub-sub-submenu-list">
                                ...
                                <ul class="collapse list-unstyled sub-sub-submenu">
                                    ...
                                    <li><router-link to="/tables/v3-table/multiple-tables">Multiple Tables</router-link>
                                    </li>
                                    <li><router-link to="/tables/v3-table/alt-pagination">Alt. Pagination</router-link>
                                    </li>
