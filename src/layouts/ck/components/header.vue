            ...
            <header class="header navbar navbar-expand-sm">
                <ul class="navbar-item theme-brand flex-row text-center">
                    <li class="nav-item theme-logo">
                        <router-link to="/">
                            <img src="/src/assets/ck/images/logo.svg" class="navbar-logo" alt="logo" />
                        </router-link>
                    </li>
                ...
                <div class="d-none horizontal-menu">
                    <a href="javascript:void(0);" class="sidebarCollapse" data-placement="bottom" @click="themeStore.toggleSideBar(!themeStore.state.is_show_sidebar)">
                ...
                <ul class="navbar-item flex-row ms-md-0 ms-auto">
                    <li class="nav-item align-self-center search-animated" :class="{ 'show-search': themeStore.state.is_show_search }">
                        <svg
                            @click="themeStore.toggleSearch( !themeStore.state.is_show_search)"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                ...
                <div class="navbar-item flex-row ms-md-auto">
                    ...
                    <div class="dropdown nav-item language-dropdown btn-group">
                        <a href="javascript:;" id="ddllang" data-bs-toggle="dropdown" aria-expanded="false" class="btn dropdown-toggle btn-icon-only nav-link">
                            <img v-if="selectedLang" :src="`/src/assets/ck/images/flags/${selectedLang.code}.png`" class="flag-width" alt="flag" />
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="ddllang">
                            <perfect-scrollbar>
                                <li>
                                    <a href="javascript:;" class="dropdown-item">
                                        <img src="/src/assets/ck/images/flags/en.png" class="flag-width" alt="flag" />
                                        <span>English</span>
                                    </a>    
                                </li>
                            </perfect-scrollbar>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right m-0" aria-labelledby="ddlmsg">
                            ...
                            <li role="presentation">
                                <a role="menuitem" href="#" target="_self" class="dropdown-item">
                                    <div class="media media">
                                        <div class="media-aside align-self-start">
                                            <img src="/src/assets/ck/images/profile-15.jpeg" alt="avatar" />
                                        </div>
                                        <div class="media-body">
                    ...
                    <div class="dropdown nav-item user-profile-dropdown btn-group">
                        <a href="javascript:;" id="ddluser" data-bs-toggle="dropdown" aria-expanded="false" class="btn dropdown-toggle btn-icon-only user nav-link">
                            <img src="/src/assets/ck/images/profile-16.jpeg" alt="avatar" />
                        </a>
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled">
                            ...
                            <li>
                                <router-link to="/index2">Analítica</router-link>
                            </li>
                        </ul>
                    </li>
...
// const store = useStore();
    ...
    /// IFR Eliminado const i18n = reactive(useI18n());
