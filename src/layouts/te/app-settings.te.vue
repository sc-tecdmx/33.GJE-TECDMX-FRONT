        ...
        <div class="app-settings" :class="{ active: isOpen }">
            ...
            <perfect-scrollbar class="sidbarchat p-3" tag="div">
                ...
                <div class="text-center">
                    <img src="/src/assets/ck/images/features_overview.svg" alt="..." class="img-fluid" />
                </div>
                ...
                <div class="btn-group-toggle row mb-4 mx-0">
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="light_mode" v-model="themeStore.state.dark_mode" class="custom-control-input" value="light" @change="setTemplateStyle" />
                    ...
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="dark_mode" v-model="themeStore.state.dark_mode" class="custom-control-input" value="dark" @change="setTemplateStyle" />
                    ...
                    <div class="text-color radio-primary col-12 ps-0 custom-control custom-radio">
                        <input type="radio" id="system_mode" v-model="themeStore.state.dark_mode" class="custom-control-input" value="system" @change="setTemplateStyle" />
                ...
                <div class="btn-group-toggle row mb-4 mx-0">
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="horizontal" v-model="themeStore.state.menu_style" class="custom-control-input" value="horizontal" @change="setMenuStyle" />
                        <label class="custom-control-label" for="horizontal">Horizontal</label>
                    </div>
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="vertical" v-model="themeStore.state.menu_style" class="custom-control-input" value="vertical" @change="setMenuStyle" />
                    ...
                    <div class="text-color radio-primary col-12 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="collapsible" v-model="themeStore.state.menu_style" class="custom-control-input" value="collapsible-vertical" @change="setMenuStyle" />
                ...
                <div class="btn-group-toggle row mx-0">
                    <div class="text-color radio-primary col-3 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="boxed" v-model="themeStore.state.layout_style" class="custom-control-input" value="boxed-layout" @change="setLayoutStyle" />
                    ...
                    <div class="text-color radio-primary col-5 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="largeboxed" v-model="themeStore.state.layout_style" class="custom-control-input" value="large-boxed-layout" @change="setLayoutStyle" />
                    ...
                    <div class="text-color radio-primary col-4 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="full" v-model="themeStore.state.layout_style" class="custom-control-input" value="full" @change="setLayoutStyle" />
