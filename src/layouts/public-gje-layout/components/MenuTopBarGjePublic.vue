        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled">
                    <li>
                        <a href="https://www.tecdmx.org.mx/"> Nuestro Tribunal </a>
                    </li>
                    <li>
                        <a href="https://www.tecdmx.org.mx/">Pleno </a>
                    </li>
                    <li>
                        <router-link to="#">Áreas</router-link>
                    </li>
                    <li>
                        <router-link to="#">Directorio</router-link>
                    </li>
                    <li>
                        <router-link to="#">Programas TECDMX</router-link>
                    </li>
                    <li>
                        <router-link to="#">Marco Normativo</router-link>
                    </li>
                    <li>
            ...
            <li class="menu single-menu">
                <a href="javascript:;" class="dropdown-toggle">
                    <div class="">
                        <span>Actividad Jurisdiccional</span>
                    </div>
                </a>
                <ul class="collapse submenu list-unstyled">
                    <li>
                        <router-link to="/"> Sesiones Públicas</router-link>
                    </li>
                    <li>
                        <router-link to="/"> Sentencias</router-link>
                    </li>
                </ul>
            </li>

            <li class="menu single-menu">
                <a href="https://sentencias.tecdmx.org.mx/buscar/" class="dropdown-toggle">
                    <div class="">
                        <span>Buscador Jurisdiccional</span>
                    </div>
                </a>
            </li>
            ...
            <li class="menu single-menu">
                <a href="javascript:;" class="dropdown-toggle">
                    <div class="">
                        <span>Tribunal Abierto</span>
                    </div>
                </a>
            </li>

            <li class="menu single-menu">
                <a href="https://transparencia.tecdmx.org.mx/Cumplimiento-Ley-Contabilidad-Gubernamental/"
...
.topbar-nav.header nav.topbar ul.menu-categories li.menu .submenu li a:visited {
    color: #ffffff;
