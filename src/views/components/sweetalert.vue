...
new window.Swal({
    ...
    imageUrl: '/src/assets/ck/images/thumbs-up.jpg',
    imageWidth: 224,
    imageHeight: 200,
...
new window.Swal({
    ...
    background: '#fff url(' + '/src/assets/ck/images/sweet-bg.jpg' + ') no-repeat 100% 100%'
});
                                        </pre>
                                    </highlight>
                                </div>
...
<script setup>
    ...
    import "/src/assets/ck/sass/components/custom-sweetalert.scss";
