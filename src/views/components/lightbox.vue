...
<script setup>
    ...
    import "/src/assets/ck/sass/components/custom-lightbox.scss";
    ...
    const initData = () => {
        if (allControls.value) {
            items.value = [
                {
                    src: "/src/assets/ck/images/lightbox-1.jpg",
                ...
                {
                    src: "/src/assets/ck/images/lightbox-8.jpeg",
                    title: "This is dummy caption. It has been placed here solely to demonstrate the look and feel of finished, typeset text.",
                    description: "Photo: Samuel Rohl",
                },
                {
                    src: "/src/assets/ck/images/lightbox-3.jpeg",
