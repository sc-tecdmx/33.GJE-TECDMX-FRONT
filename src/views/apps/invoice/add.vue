                                    ...
                                    <div class="invoice-detail-title">
                                        <div class="invoice-logo">
                                            <div class="upload pe-md-4">
                                                ...
                                                <img v-if="selected_file" :src="selected_file ? selected_file : '/src/assets/ck/images/user-profile.jpeg'" alt="profile" class="profile-preview" @click="$refs.fl_profile.click()" />
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="dropdown selectable-dropdown invoice-select d-block btn-group">
                                            <a href="javascript:;" id="ddlCurrency" class="btn dropdown-toggle btn-icon-only text-nowrap" data-bs-toggle="dropdown" aria-expanded="false">
                                                <img :src="'/src/assets/ck/images/' + selected_currency.thumb" class="flag-width" alt="flag" />
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="ddlCurrency">
                                                <li v-for="(item, index) in currency_list" :key="index">
                                                    <a href="javascript:;" class="dropdown-item" @click="selected_currency = item"> <img :src="'/src/assets/ck/images/' + item.thumb" class="flag-width" alt="flag" /> {{ item.key }} </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
...
<script setup>
    ...
    import "/src/assets/ck/sass/apps/invoice-add.scss";
