...
<script setup lang="ts">
    ...
    import ListaCAcceso from '@/components/apps/jel/ListaCAcceso.vue';
    import ModalControlCheck2 from '@/components/common/ModalControlCheck2.vue';
    ...
    components.value = [
        ...
        { liClass: 'breadcrumb-item', rutaName: '/inst/acceso/usuario', aClass: 'text-primary fw-normal fs-6', texto: 'Usuarios', iconClass: '', slash: '', spanClass: 'span' },
        // MÁS...
    ];
    }
    ...
    { id: '1', type: 'checkbox', label: 'Administrador', model: 'opcion'},
    { id: '2', type: 'checkbox', label: 'Ciudadano', model: 'codigo' },
    { id: '3', type: 'checkbox', label: 'Secretaría', model: 'nombre' },
    { id: '4', type: 'checkbox', label: 'Ponencia', model: 'slug' }
    ]);
