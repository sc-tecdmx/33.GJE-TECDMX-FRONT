...
<script setup lang="ts">
    ...
    components.value = [
        ...
        { liClass: 'breadcrumb-item', rutaName: '/inst/acceso/permiso', aClass: 'text-primary fw-normal fs-6', texto: 'Rol', iconClass: '', slash: '', spanClass: 'span' },
        // MÁS...
    ];
    }
